...
let current_users = ["sana", "saira", "sonia", "sumaira", "Parizah"];
// List of new usernames
let new_users = ["aliana", "saira", "aizal", "arish", "sana"];
...
for (let new_user of new_users) {
    ...
    // Check if new username already exists in current_users (case-insensitive)
    if (current_users_lower.includes(new_Users_lower)) {
        console.log(`The username '${new_user}' is not available. Please enter new username.`);
    }
    else {
